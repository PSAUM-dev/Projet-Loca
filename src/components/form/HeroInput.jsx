...
const HeroInput = ({ label, placeHolder, className }) => {
    return (
        ...
        <div className={`flex flex-col text-left px-6 ${className}`}>
            ...
            <input className="w-full text-sm border-0 bg-transparent text-gray-900 p-0 focus:outline-none focus:border-transparent" id="location-search" placeholder={placeHolder} type="text" />
        </div>
